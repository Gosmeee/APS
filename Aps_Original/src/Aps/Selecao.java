...
public class Selecao extends javax.swing.JFrame {
    ...
    private void btnCalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCalcularActionPerformed
        ...
        }else if(cmbxProduto.getSelectedIndex() == 3)
        {
            ...
            if(eletro.calculo_consumo() <= 152.2)
            {
                lblException.setText("<html> Parabéns, seu consumo de energia está <br> abaixo da média!!");
                lblException.setForeground(new Color(19,202,29));
            }else
            {
                lblException.setText("<html> Seu consumo de energia está <br> acima da média :c");
                lblException.setForeground(new Color(223,0,0));
            }
        }
